export const SCALES = [
  {
    ...
    description: {
      ...
      ru: 'Гамма «света» — мажорный характер без полутонов. Встречается в народных песнях, праздничной музыке и мин\'ё. Открытая, радостная, бодрая. Расширенная 7-нотная форма (гамма мин\'ё) также имеет разные проходящие тоны при движении вверх и вниз.',      zh: '“阳”音阶，明亮的特性而无半音。常见于民谣、节庆音乐和民谣（min’yo）。开阔、欢快、振奋。7 音扩展形式（民谣音阶）在上行和下行时也有不同的经过音。',    },
  },
  {
    id: 'miyako_bushi',
    nameEn: 'Miyako-bushi',
